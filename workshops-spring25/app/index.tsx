...
const RectVertex = (props: RectVertexProps) => {
	...
	// TODO: fix what is passed to onPress, the rest is fine
	return (
		<Pressable
	...
	return (
		<View style={styles.mainView}>
			...
			<View
				...
				{
					// PART 3: uncomment the line of code below and delete curly brackets
					//<RectGrid height={examplePuzzle.height} width={examplePuzzle.width} />
				}
				{
					// PART 2: uncomment the line of code below and delete curly brackets
